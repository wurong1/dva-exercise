...
class SalesUndistributedCustomerPage extends Component {
  state = {
  ...
  render() {
    const { searchList, deploy, customerIds, selectedRowKeys, setSelectedArr,
      setCustomerIds, isModalShow, openModal, closeModal, deployLoading,
...
SalesUndistributedCustomerPage.propTypes = {
};

export default connect(
  state => ({
    searchList: state.undistributedCustomer.salesSearchList,
    isModalShow: state.undistributedCustomer.isModalShow,
    selectedRowKeys: state.undistributedCustomer.selectedRowKeys,
    customerIds: state.undistributedCustomer.customerIds,
    deployLoading: state.undistributedCustomer.deployLoading,
    loading: state.loading.models.undistributedCustomer,
  }),
  dispatch => ({
    salesSearch: (params) => {
      dispatch({ type: 'undistributedCustomer/salesSearch', payload: params });
    },
    salesReset: () => {
      dispatch({ type: 'undistributedCustomer/salesReset' });
    },
    openModal: () => {
      dispatch({ type: 'undistributedCustomer/openModal' });
    },
    deploy: (params) => {
      dispatch({ type: 'undistributedCustomer/deploy', payload: params });
    },
    closeModal: () => {
      dispatch({ type: 'undistributedCustomer/closeModal' });
    },
    setSelectedArr: (params) => {
      dispatch({ type: 'undistributedCustomer/setSelectedArr', payload: params });
    },
    setCustomerIds: (params) => {
      dispatch({ type: 'undistributedCustomer/setCustomerIds', payload: params });
    },
  }),
)(Form.create()(SalesUndistributedCustomerPage));
