...
class MyLoanTaskPage extends Component {
  state = {
    isReset: false,
    isFollowedUp: false,
      ...
      <div>
        ...
        >
          <Spin spinning={modal.loading}>
            <DeployModal key={loanDeployVisible} taskOptions="LOANAPPGUIDED" taskType="MINE_TASK" />
          </Spin>
        </Modal>
        <Modal
          title="转给分公司"
        ...
        >
          <Spin spinning={modal.loading}>
            <TransferModal key={loanTransferVisible} taskOptions="LOANAPPGUIDED" taskType="MINE_TASK" />
          </Spin>
        </Modal>
        <Modal
          title="分配签约人"
        ...
        >
          <Spin spinning={modal.loading}>
            <SignModal key={loanSignVisible} taskOptions="LOANAPPGUIDED" taskType="MINE_TASK" />
          </Spin>
        </Modal>
      </div>
    );
...
export default connect(
  state => ({
    ...
    productcodeList: state.myTasks.loanProductcodeList,
    searchList: state.myTasks.loanTaskList,
    loading: state.myTasks.loanTaskLoading,
    taskLoan: state.myTasks.taskLoan,
  ...
  dispatch => ({
    ...
    getLoanProductcode: (guidedType) => {
      dispatch({ type: 'myTasks/getLoanProductcode', payload: guidedType });
    },
    loanSearchListReset: () => {
      dispatch({ type: 'myTasks/loanSearchListReset' });
    },
    loanTaskSearch: (formData, pageData) => {
      ...
      dispatch({ type: 'myTasks/loanTaskSearch', payload: resultData });
    },
    getButtonConfig: parmas => dispatch({ type: 'myTasks/getButtonConfig', payload: parmas }),
    taskLoansetRows: parmas => dispatch({ type: 'myTasks/taskLoansetRows', payload: parmas }),
    showLoanDeployModal: parmas => dispatch({ type: 'myTasks/showLoanDeployModal', payload: parmas }),
    showLoanTransferModal: parmas => dispatch({ type: 'myTasks/showLoanTransferModal', payload: parmas }),
    showSignTransferModal: parmas => dispatch({ type: 'myTasks/showSignTransferModal', payload: parmas }),
    taskLoanPageChange: parmas => dispatch({ type: 'myTasks/taskLoanPageChange', payload: parmas }),
  }),
)(Form.create()(MyLoanTaskPage));
