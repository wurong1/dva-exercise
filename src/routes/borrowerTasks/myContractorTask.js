...
class MyContractorPage extends Component {
  state = {
    isFollowedUp: false,
  };
      ...
      <div className="task">
        ...
        >
          <Spin spinning={modal.loading}>
            <DeployModal key={contractDeployVisible} taskOptions="CONTRACT" taskType="MINE_CONTRACT" />
          </Spin>
        </Modal>
        <Modal
          title="转给分公司"
        ...
        >
          <Spin spinning={modal.loading}>
            <TransferModal key={contractTransferVisible} taskOptions="CONTRACT" taskType="MINE_CONTRACT" />
          </Spin>
        </Modal>
        <Modal
          title="分配签约人"
        ...
        >
          <Spin spinning={modal.loading}>
            <SignModal key={contractSignVisible} taskOptions="CONTRACT" taskType="MINE_CONTRACT" />
          </Spin>
        </Modal>
      </div>
    );
...
MyContractorPage.propTypes = {
};

export default connect(
    state => ({
      productcodeList: state.teamTasks.signProductcodeList,
      searchList: state.myTasks.contractorList,
      loading: state.myTasks.contractorLoading,
      taskContract: state.myTasks.taskContract,
    ...
    dispatch => ({
      ...
      contractorSearchListReset: () => {
        dispatch({ type: 'myTasks/contractorSearchListReset' });
      },
      contractorSearch: (formData) => {
        ...
        resultData.flag = 'MINE_CONTRACT';
        dispatch({ type: 'myTasks/contractorSearch', payload: resultData });
      },
      getButtonConfig: parmas => dispatch({ type: 'myTasks/getButtonConfig', payload: parmas }),
      taskContractsetRows: parmas => dispatch({ type: 'myTasks/taskContractsetRows', payload: parmas }),
      showContractDeployModal: parmas => dispatch({ type: 'myTasks/showContractDeployModal', payload: parmas }),
      showContractTransferModal: parmas => dispatch({ type: 'myTasks/showContractTransferModal', payload: parmas }),
      showContractSignModal: parmas => dispatch({ type: 'myTasks/showContractSignModal', payload: parmas }),
      taskContractPageChange: parmas => dispatch({ type: 'myTasks/taskContractPageChange', payload: parmas }),
    }),
)(Form.create()(MyContractorPage));
