...
import { Form, Input, Select, DatePicker, Radio, Row, Col, Table, Tabs, Steps, Badge } from 'antd';
...
class HoldTaskDetailsReadonly extends Component {
  constructor(props) {
    super(props);
    this.state = {
      result: [],
  ...
  render() {
    const { result, showOriginPhone, showOriginSSn } = this.state;
    const {
      reviewList,
      taskDetailsList,
      scheduleList,
                ...
                <div>
                  {
                    ...
                    <Form>
                      ...
                      <Row>
                        <Col offset={4} span={4}>{output}</Col>
                      </Row>
                    </Form>
                  }
                  <Row>
                    <Col span={3}>
                      ...
                      <span className="badge-span-title">
                        是否结案: {taskDetailsList && taskDetailsList.isClosed === 1 ? '是' : '否'}
                      </span>
                    </Col>
                  </Row>
                </div>
...
HoldTaskDetailsReadonly.propTypes = {
};
...
)(Form.create()(HoldTaskDetailsReadonly));
