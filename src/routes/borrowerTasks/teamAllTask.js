...
class TeamAllTaskPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <div>
        ...
        >
          <Spin spinning={modal.loading}>
            <DeployModal key={allDeployVisible} taskOptions="ALL" taskType="GROUP_TASK" />
          </Spin>
        </Modal>
        <Modal
          title="转给分公司"
        ...
        >
          <Spin spinning={modal.loading}>
            <TransferModal key={allTransferVisible} taskOptions="ALL" taskType="GROUP_TASK" />
          </Spin>
        </Modal>
        <Modal
          title="分配签约人"
        ...
        >
          <Spin spinning={modal.loading}>
            <SignModal key={allSignVisible} taskOptions="ALL" taskType="GROUP_TASK" />
          </Spin>
        </Modal>
      </div>
    );
...
export default connect(
  ...
  dispatch => ({
    getEmployeeGroup: () => dispatch({ type: 'teamTasks/getEmployeeGroup' }),
    getIntentionsource: () => dispatch({ type: 'teamTasks/getIntentionsource' }),
    getFirstRecommend: () => dispatch({ type: 'teamTasks/getFirstRecommend' }),
    taskAllsubmit: parmas => dispatch({ type: 'teamTasks/taskAllsubmit', payload: parmas }),
    taskAllPageChange: parmas => dispatch({ type: 'teamTasks/taskAllPageChange', payload: parmas }),
    taskAllsetRows: parmas => dispatch({ type: 'teamTasks/taskAllsetRows', payload: parmas }),
    getButtonConfig: parmas => dispatch({ type: 'teamTasks/getButtonConfig', payload: parmas }),
    showAllDeployModal: parmas => dispatch({ type: 'teamTasks/showAllDeployModal', payload: parmas }),
    showAllTransferModal: parmas => dispatch({ type: 'teamTasks/showAllTransferModal', payload: parmas }),
    showAllSignModal: parmas => dispatch({ type: 'teamTasks/showAllSignModal', payload: parmas }),
    clearTakAll: () => dispatch({ type: 'teamTasks/clearTakAll' }),
  }),
)(Form.create()(TeamAllTaskPage));
