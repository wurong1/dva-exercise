...
class MyDeployModal extends Component {
  ...
  componentWillMount() {
    ...
    const params = { taskType, operationType: 'TO_ALLOCATE' };
...
export default connect(
  ...
  dispatch => ({
    getGroup: params => dispatch({ type: 'myTasks/getGroup', payload: params }),
    getEmployeeUser: params => dispatch({ type: 'myTasks/getEmployeeUser', payload: params }),
    setCheckedList: params => dispatch({ type: 'myTasks/setCheckedList', payload: params }),
    modalSubmit: params => dispatch({ type: 'myTasks/modalSubmit', payload: params }),
  }),
)(Form.create()(MyDeployModal));
