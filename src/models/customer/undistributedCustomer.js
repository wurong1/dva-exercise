...
export default {
  namespace: 'undistributedCustomer',
  ...
  effects: {
    ...
    * phoneDeploy({ payload }, { call, put, select }) {
      try {
        ...
        const searchData = yield select(state => state.undistributedCustomer.phoneSearchParams);
    ...
    * deploy({ payload }, { call, put, select }) {
      try {
        ...
        const searchData = yield select(state => state.undistributedCustomer.searchParams);
