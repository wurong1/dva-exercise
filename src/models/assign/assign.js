...
export default {
  ...
  effects: {
    ...
    * getButtonConfig({ payload }, { put, call }) {
      try {
        yield put({ type: 'beforeGetButtonConfig' });
        const data = yield call(getButtonConfig, payload);
        yield put({ type: 'getButtonConfigSuccess', payload: data || {} });
      } catch (e) {
        yield put({ type: 'getButtonConfigFaild' });
        console.error(e);
      }
    },
  },
  ...
  reducers: {
    ...
    getButtonConfigSuccess(state, { payload }) {
      return {
        ...state,
        btnConfig: {
          ...state.btnConfig,
