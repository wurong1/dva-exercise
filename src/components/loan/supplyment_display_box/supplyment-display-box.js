...
class SupplymentDisplayBox extends Component {
  ...
  getFileList(e) {
    ...
    remote({
      method: 'GET',
      url: '/borrower/getallloanimageforauditbytype?aid=' + this.context.loanInfoData.aid + '&loanAppId=' + this.context.loanInfoData.loanId + '&type=' + this.props.boxInfo.type + '&taskStatus=hold' + '&routingSystem=' + this.context.loanInfoData.routingSystem + '&conditionId=' + this.props.boxInfo.docId
    }).then((data) => {
      this.showModal();
  ...
  deleteFile(record, e) {
    ...
    confirm({
      ...
      onOk() {
        remote({
          method: 'DELETE',
          url: '/borrower/deleteborrowerdocument?aId=' + this.context.loanInfoData.aid + '&loanId=' + this.context.loanInfoData.loanId + '&docId=' + record.docId + '&docFileId=' + record.docFileId + '&type=' + record.type + '&taskStatus=hold' + '&routingSystem=' + this.context.loanInfoData.routingSystem
        }).then((data) => {
  ...
  render() {
    ...
    const action = this.context.loanInfoData.routingSystem === 'ICRC' ? '/borrower/uploadLoanappIcrcFile' : '/borrower/uploadloanimages';
    const data = this.context.loanInfoData.routingSystem === 'ICRC' ? {'loanId': this.context.loanInfoData.loanId, 'conditionId': this.props.boxInfo.docId, 'status': 'hold'} : {'aid': this.context.loanInfoData.aid};
        ...
        <Modal title={name} visible={this.state.visible}
          ...
          <div className="t-center ">
            {fileGroup !== 'FILL_SUBMIT' ?
              this.context.loanInfoData.detailType === 'AUTOFLLOWUP' &&
                <label className="label label-warning"></label>
              :
